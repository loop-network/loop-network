          ...
          <div class="card-deck">
            <div class="col-md-6 col-lg-6 col-12 d-flex align-items-stretch">
                ...
                <div class="card-body yellow-background">
                  <p class="card-text">"LOVED getting to meet such a diverse group of girls and hear their struggles and passions. I also loved Sri and her way of incorporating the entire group in discussions and in really making the session seem interactive... Thank you for this opportunity!"</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-6 col-lg-6 col-12 d-flex align-items-stretch">
              <div class="card mb-4">
                <div class="card-body yellow-background">
                  <p class="card-text">"I liked the breakout rooms and being able to connect more deeply with another cohort member. I think having more group discussions would also be very beneficial for fostering a communicative and inclusive cohort."</p>
                </div>
                <div class="card-body">
                  <div class="row speaker">
                    <div class="col-md-3 col-lg-3 col-3 d-flex align-items-stretch">
