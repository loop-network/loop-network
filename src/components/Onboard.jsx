...
import {Form, FormControl, FormGroup, ControlLabel, HelpBlock, Checkbox, Radio, Button, Dropdown, DropdownButton} from 'react-bootstrap';
...
function Onboard({history}) {
  ...
  const handleSubmit = (event) => {
    ...
    const{ highestEducation, workExperience, position} = event.target.elements;
          ...
          <div class="col-lg-5">
            ...
            <form onSubmit = {handleSubmit}>
                <Form.Group controlId="highestEducation">
                    ...
                    <DropdownButton title={highestEd} onSelect={function(evt){setEd(evt)}} onChange = {e => handleEdChange(e)}>
                      <Dropdown.Item eventKey='High School'>High School</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Undergraduate'>Undergraduate</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Masters/PhD'>Master's or PhD</Dropdown.Item>
                    </DropdownButton>
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" for="defaultUnchecked">1-5 years</label>
           
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="defaultUnchecked3"/>
                  <label class="custom-control-label" for="defaultUnchecked">4-6 years</label>   
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="defaultUnchecked4"/>
                  <label class="custom-control-label" for="defaultUnchecked">6-10 years</label>   
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="defaultUnchecked5"/>
                  <label class="custom-control-label" for="defaultUnchecked">10+ years</label>   
                </div>
              </Form.Group>

              <Form.Group controlId="position">
                    <Form.Label>Please select what best describes your position</Form.Label>
                  
                    <DropdownButton title={position} onSelect={function(evt){setPos(evt)}} onChange = {e => handleEdChange(e)}>
                      <Dropdown.Item eventKey='High School'>High School</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Undergraduate'>Undergraduate</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Masters/PhD'>Master's or PhD</Dropdown.Item>
                    </DropdownButton>
                ...
                <Form.Group controlId="sector">
                    ...
                    <DropdownButton title={sector} onSelect={function(evt){setSector(evt)}} onChange = {e => handleEdChange(e)}>
                      <Dropdown.Item eventKey='Consumer'>Consumer</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Enterprise'>Enterprise</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Emerging Tech'>Emerging Tech</Dropdown.Item>
                    </DropdownButton>
                   
                </Form.Group>

                <Form.Group controlId = "description">
                  <Form.Label>Please provide 1 sentence describing your startup.</Form.Label>
                  <Form.Control type="description" placeholder="Describe your startup" />
                </Form.Group>

                <Form.Group controlId = "expertise">
                  <Form.Label>What is your area of expertise?</Form.Label>
                  <DropdownButton title={expertise} onSelect={function(evt){setExpertise(evt)}}>
                      <Dropdown.Item eventKey='Engineering'>Engineering</Dropdown.Item>
                      <Dropdown.Item eventKey= 'Brand and Strategy'>Brand and Strategy</Dropdown.Item>
                      <Dropdown.Item eventKey= 'People and Culture'>People and Culture</Dropdown.Item>
                    </DropdownButton>
                </Form.Group>
                <Form.Group controlId = "similarity">
                  <Form.Label>Do you want to connect with people who are similar to you?</Form.Label>
                ...
                <Form.Group controlId = "matchFormat">
                  ...
                  <DropdownButton title={matchFormat} onSelect={function(evt){setMatchFormat(evt)}}>
                      ...
                      <Dropdown.Item eventKey= 'International'>Eastern</Dropdown.Item>
                    </DropdownButton>
                </Form.Group>
                <Form.Group controlId = "startupStage">
                  <Form.Label>Are you working on a Startup?</Form.Label>
                  <DropdownButton title={startupStage} onSelect={function(evt){setStartupStage(evt)}}>
                      <Dropdown.Item eventKey='Ideation/Early'>Ideation/Early</Dropdown.Item>
